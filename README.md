...
| 2 | **브라우저 모델** | Qwen3 0.6B q4f16 **570MB**를 WebGPU로. **버튼을 눌러야만** 받습니다 |
...
더 큰 1.7B(1.4GB)도 그 표에 있으니 기본을 바꾸려면 순서만 바꾸면 됩니다. 헤더에 버튼을
둘 두지 않는 이유는 390px 화면에서 헤더가 58 → 106px로 부풀기 때문입니다.
