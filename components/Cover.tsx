      ...
      <div className="cover__stage">
        <div className="plate plate--name">
          ...
          <h1 className="plate__title">
            먼저 어디서<br />
            <span className="plate__title-mark">무너질지</span>부터 봅니다.
          </h1>
          <p className="plate__body">
            ZIVO에서 웹·어드민·백엔드를 함께 만들었습니다. 앱보다 웹을 먼저 출시했고, 결제와
            권한은 실패할 자리를 먼저 닫았고, 검색과 쿠폰은 운영 중 깨질 경계를 다시 나눴습니다.
            아래 창에 물어보면 그 판단의 앞뒤를 보여드립니다.
          </p>
        </div>
